  ...
  <div class="w-[50px] bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 p-5 my-5">
    ...
    <div class="mt-4">
      ...
      <form @submit.prevent="addComment" class="flex">
        ...
        <button type="submit" class="ml-2 text-white bg-blue-600 hover:bg-blue-600 font-medium rounded-lg text-sm px-4 py-2">
          Add
        </button>
      </form>
    </div>
