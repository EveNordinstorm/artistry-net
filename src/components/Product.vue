...
<template>
  <div class="bg-blue-600 rounded-xl my-5 p-2">
    <div
      class="w-[50px] bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 p-5"
    >
      ...
      <img
        ...
        alt="product photo"
      />
      <div class="inline-block bg-blue-700 rounded-full my-3 mr-3">
        <p class="py-1.5 px-4 text-xl font-bold text-white">
          {{ formattedPrice }}
        </p>
      </div>

      <button
        class="font-bold bg-gradient-to-br from-red-400 to-blue-700 text-white hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2"
      >
        Shop Now
      </button>
      <!-- Delete Button -->
